...
{\centering\captionof{table}{Porte logiche}\index{Funzione!logica}\index{AND}\index{NAND}\index{OR}\index{NOR}\index{XOR}\index{XNOR}\index{NOT}
...
{\centering\captionof{table}{Composizione porte}%
		\begin{tabular}{ccc}
	\toprule
