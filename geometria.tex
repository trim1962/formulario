...
{\centering\captionof{figure}{Triangoli classicazione lati angoli}
\centering\includestandalone{grafici/trangoliClasLati}}

{\centering\captionof{figure}{Triangoli classicazione angoli}
\centering \includestandalone{grafici/trangoliClasAngoli}}
...
\end{align*}\index{Triangolo!area}\index{Triangolo!perimetro}\index{Triangolo!altezza}\index{Erone!formula}

\section{Triangolo rettangolo}
\begin{defn}[Triangolo rettangolo]
Triangolo con un angolo interno retto.
\end{defn}
	\begin{align*}
...
a=&p_1+p_2
\end{align*}\index{Triangolo!rettangolo!area}\index{Triangolo!rettangolo!altezza}\index{Triangolo!rettangolo!cateto}\index{Triangolo!rettangolo!ipotenusa}\index{Pitagora!teorema}\index{Euclide!primo teorema}\index{Euclide!secondo teorema}
...
\begin{tcolorbox}[sidebyside,righthand width=9cm,colback=white,colframe=white,fonttitle=\bfseries	]
	\includestandalone[width=4.4cm]{geometria/circonferenza2}
	\tcblower
	\begin{align*}
	A=&\pi r^2 & P=&2\pi r	\\
	d=&2r&r=&\sqrt{\dfrac{A}{\pi}}\\
	r=&\frac{d}{2}&r=&\frac{P}{2\pi}\\
	\end{align*}
\end{tcolorbox}\index{Circonferenza!perimetro}\index{Cerchio!area}\index{Circonferenza!raggio}\index{Circonferenza!diametro}
\section{Corona circolare}\index{Corona circolare}
\begin{tcolorbox}[sidebyside,righthand width=9cm,colback=white,colframe=white,fonttitle=\bfseries	]
	\includestandalone[width=4.4cm]{geometria/coronacirc1}
	\tcblower
	\begin{align*}
	A=&\pi(R^2-r^2) & R>&r\\
\end{align*}
\end{tcolorbox}\index{Corona circolare!area}
...
\end{tcolorbox}
%\newpage
{\centering\captionof{table}{Poligoni regolari }\index{Poligono!regolare}
	\begin{tabular}{lcll}
		\toprule
