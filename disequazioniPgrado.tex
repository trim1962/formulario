...
{\centering\captionof{table}{Equazione e disequazione di primo grado}\index{Disequazione!primo grado!soluzione}
	\begin{tabular}{CCCC}
	\toprule
	& \text{Equazione} & \text{Disequazione} & \text{Disequazione} \\
	\midrule
	&ax=b  & ax>b & ax<b \\[.5cm]
