...
\begin{document}
	\begin{longtable}{
	S[table-format = 4.0,table-text-alignment = center,table-number-alignment = center]@{\hspace{0.1cm}}
			S[table-format = 6.0,table-text-alignment = center,table-number-alignment = center]@{\hspace{0.1cm}}
			S[table-format = 9.0,table-text-alignment = center,table-number-alignment = center]@{\hspace{0.1cm}}
			S[table-format = 2.4,table-text-alignment = center,table-number-alignment = center]@{\hspace{0.1cm}}
			S[table-format = 2.4,table-text-alignment = center,table-number-alignment = center]@{\hspace{0.1cm}}
			l@{\hspace{0.3cm}} %
