...
\begin{center}
	...
	\captionof{figure}{Funzione seno grafico}
...
\item $\omega=\dfrac{2\pi}{\tau}$ si misura in  \SI[parse-numbers=false]{}{\radian\per\second} pulsazione\index{Funzione!sinusoidale!pulsazione} o velocità angolare 
