...
\newglossaryentry{asintotog}{name={Asintoto},description={retta che si avvicina indefinivamente ad una retta data}}
...
\newglossaryentry{coefficienteangolareg}{name={Coefficiente angoolare},description={nella geometria analitica rappresenta il coefficiente legato all'inclinazione di una retta rispetto all'asse delle ascisse}}
...
\newglossaryentry{figuraconcavag}{name={Figura concava},description={in geometria una figura è concava se esistono due punti della figura tali che il segmento che li congiunge non appartiene alla figura}}
