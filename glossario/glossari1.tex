...
\newglossaryentry{limitatosupg}{name={Limitato superiormente},description={un insieme $A$ è limitato  superiormente se esiste un numero che sia maggiore o  uguale  ad ogni lemento di  $A$},see={estremosuperioreg}}
\newglossaryentry{limitatoinfg}{name={Limitato inferiormente},description={un insieme $A$ è limitato  inferiormente se esiste un numero che sia minore o  uguale  ad ogni lemento di  $A$},see={estremoinferioreg}}
