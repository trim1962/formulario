...
\newglossaryentry{ag}{name={A},description={il numero dieci in base 16}}
...
\newglossaryentry{bg}{name={B},description={il numero undici in base 16}}
...
\newglossaryentry{cg}{name={C},description={il numero dodici in base 16}}
...
\newglossaryentry{cnug}{name={C},description={insieme dei numeri complessi},see={numcompg}}
...
\newglossaryentry{crg}{name={C},description={il numero cento nel sistema di numerazione romano}}
...
\newglossaryentry{dg}{name={D},description={numero tredici in base 16}}
...
\newglossaryentry{drg}{name={D},description={numero 500 in nella numerazione romana}}
\newglossaryentry{eg}{name={E},description={il numero quattordici in base 16}}
...
\newglossaryentry{fg}{name={F},description={il numero quindici in base 16}}
...
\newglossaryentry{irg}{name={I},description={il numero uno nel sistema di numerazione romano}}
\newglossaryentry{jg}{name={j},description={unità immaginaria}}
...
\newglossaryentry{lrg}{name={L},description={il numero cinquanta nel sistema di numerazione romano}}
...
\newglossaryentry{qnug}{name={Q},description={insieme dei numeri razionali}}
...
\newglossaryentry{rnug}{name={R},description={insieme dei numeri reali}}
...
\newglossaryentry{znug}{name={Z},description={insieme dei numeri interi}}