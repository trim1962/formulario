...
\newglossaryentry{intornopuntog}{name={Intorno circolare di un punto},description={Un intorno circolare di un punto è un intervallo aperto del tipo $I_{x_0}=\left(x_0-\delta,x_0+\delta
		\right)\quad\delta>0$},see={intervallog}}
