...
\begin{figure} %[htbp]
	\centering
	\includestandalone[width=0.9\textwidth]{grafici/gradiprimisecondiconversione}
...
\begin{enumerate}
	...
	\end{enumerate}
\item Fine
\end{enumerate}\index{Angoli!gradi!conversione}
...
%			\bottomrule
%		\end{tabular}	
%		\caption{Angoli 0 45 seno, coseno, tangente}
%	\end{subtable}
%\begin{subtable}[b]{.2\linewidth}
%	\centering
%	\begin{tabular}{r
...
%	\caption{Angoli 45 90 seno, coseno, tangente}
%\end{subtable}
%	\caption{Seno, coseno e tangente}
%\end{table}
%%\begin{table}
%%\centering
%%\begin{tabular}{r
