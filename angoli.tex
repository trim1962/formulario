...
\begin{center}
\resizebox{0.5\columnwidth}{!}{\begin{tabular}{rll}
	\toprule
...
45&0,707106781186548&0,707106781186548&1\\
 \bottomrule
\end{tabular}\captionof{table}{Angoli 0 45 seno, coseno, tangente} 
 \end{center}
 \begin{center}
	\begin{tabular}{r
			S[round-precision=\lungarrotandamento,round-mode=places]
	...
	90&1&0&{$-$}\\
		\bottomrule
	\end{tabular}\captionof{table}{Angoli 45 90 seno, coseno, tangente} 
\end{center}
