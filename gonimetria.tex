...
\end{defn}
\begin{prop}[Il seno è limitato]\label{prop:Cosenolimitato}
...
\begin{prop}[Periodo seno]\label{Prop:periodoseno}
	...
	\end{equation*}
	Se l'angolo è misurato in radianti il seno è periodico di periodo $2k\pi$\index{Funzione!periodica!coseno}
	\begin{equation*}
